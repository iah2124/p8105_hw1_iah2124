...
```{r}
mean_sample = mean(df %>% pull(sample), na.rm = TRUE)
mean_logical = mean(df %>% pull(logical_vec), na.rm = TRUE)
mean_char = mean(df %>% pull(char_vec), na.rm = TRUE)
mean_factor = mean(df %>% pull(factor_vec), na.rm = TRUE)
```
